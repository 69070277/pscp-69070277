...
```text
find if vote is surprise or not surpise if the most and lowest value different more than 2

Input:
total = float input and most = float input

Output:
print surprise or not surprise
...
```text
Step 1:get input of total and most by float(input())
Step 2:find low by using total-most*2
Step 3:find if most-low > 2:
                print("Surprising")
            else :
...
Step 1:get input of total and most by float(input())
Step 2:find low by using total-most*2
Step 3:if low <0 make low = 0
Step 4:find if most-low > 2:
                print("Surprising")
            else :
                print("Not surprising")
change cause low below 0
```
