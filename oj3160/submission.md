...
```text
find prime number in range start and end
input:  start , end
output: number that is prime in range and total amount of it
...
start and end as int and prime = []
Step 2 : find prime number by using
