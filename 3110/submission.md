...
```text
OJ3110-sendwarveryvery extra large fast
```
...
```text
it have 6 line to go else is error and print tax that got from line and weigth
Input:
...
Step 2:get money
    if st == "BKK":
        ...
        fst = 30
        wkg = 60
Step 3:make rs by mix money
    rs =fst+wkg*w
Step 4:print rs if didnt go through step 2 print("ERROR")
```
